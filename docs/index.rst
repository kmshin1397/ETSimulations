...
* Generated datasets are then available to be processed with any cryo-ET software; automatic processing options are available currently for the `EMAN2 <https://blake.bcm.edu/emanwiki/EMAN2>`_ and `IMOD <https://bio3d.colorado.edu/imod/>`_ (batchruntomo) pipelines.
